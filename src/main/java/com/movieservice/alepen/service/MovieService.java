...
import com.movieservice.alepen.model.Category;
...
public class MovieService {
    ...
    public List<Movie> getAllMovies(){
        Movie movie1=new Movie(123L,"IT", Category.HORROR);
        Movie movie2=new Movie(124L,"Shrek", Category.COMEDY);
        Movie movie3=new Movie(125L,"Avatar", Category.SCIFI);
